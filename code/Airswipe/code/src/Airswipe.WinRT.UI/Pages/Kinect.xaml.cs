...
{
    public sealed partial class KinectPage : BasicPage, INotifyPropertyChanged
    {
        #region Fields

        private KinectInfo kinectInfo = new KinectInfo();
        ...
        private void InitKinectConnection()
        {
        ...
        public string KinectStatus {
            get { return "Info: " + kinectInfo.ToJson().Replace('{', ' ').Replace('}', ' '); }
        }
        ...
        private void Reader_BodyFrameArrived(object sender, BodyFrameArrivedEventArgs e)
        {
            ...
            if (dataReceived)
            {
                ...
                for (int bodyIndex = 0; bodyIndex < this.bodies.Length; bodyIndex++)
                {
                    ...
                    if (body.IsTracked)
                    {
                        ...
                        if (isFirstTrackedBody) { 
                            kinectInfo.TrackedBodyIndex = bodyIndex;

                            kinectInfo.HandLeftConfidence = body.HandLeftConfidence;
                            kinectInfo.HandRightConfidence = body.HandRightConfidence;

                            kinectInfo.HandTipLeftPosition = body.Joints[JointType.HandTipLeft];
                            kinectInfo.HandTipRightPosition = body.Joints[JointType.HandTipRight];
                        }
                        hasTrackedBody = true;
                    }
                    else
                    ...
                    if (bodyIndex == 0)
                    {
                        //LeftHandCofidenceTextBlock.Text = "Left hand confidence: " + body.HandLeftConfidence;
                ...
                kinectInfo.IsBodyTrackedInFrames = hasTrackedBody;

                notifyKinectInfoChanged();
            }
        }

        private void notifyKinectInfoChanged()
        {
            if (PropertyChanged != null)
                PropertyChanged(this, new PropertyChangedEventArgs("KinectStatus"));
        }
        ...
        private void Sensor_IsAvailableChanged(object sender, IsAvailableChangedEventArgs e)
        {
            ...
            {
                kinectInfo.StatusText = "Kinect not available";
            }
            else
            {
                kinectInfo.StatusText = "Running";
            }
        }
        ...
        //public KinectInfo { get { return kinectInfo } } ;

        #endregion
        #region Classes

        private class KinectInfo : JsonObject //, INotifyPropertyChanged
        {
            ...
            public bool IsBodyTrackedInFrames { get; internal set; }
            public int TrackedBodyIndex { get; internal set; }
            ...
            public Joint HandTipLeftPosition { get; internal set; }
            public Joint HandTipRightPosition { get; internal set; }
        }
        ...
        {
            private readonly Color RIGHT_HAND_TIP_COLOR = Colors.Pink;
            private readonly JointType POINTER_JOINT_TYPE = JointType.HandTipRight;
            ...
            public BodyInfo(Color bodyColor)
            {
                ...
                foreach (var bone in this.Bones)
                {
                    ...
                    {
                        Stroke = new SolidColorBrush(bone.Item2 == POINTER_JOINT_TYPE ? RIGHT_HAND_TIP_COLOR : BodyColor),
